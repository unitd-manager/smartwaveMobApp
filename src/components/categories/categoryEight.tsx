...
const categoryEight = (navigation: ScreenProp,
...
const CategoryCardEight = ({ data, theme, }: IProps) => {
  ...
  return (
    <View style={styles.container}>
      ...
      (
        categoryEight(navigation, index, theme, value.url, value.productName)
      ))}
    </View>
  );
};
...
export default CategoryCardEight;
